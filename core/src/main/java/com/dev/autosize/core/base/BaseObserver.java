...
import com.dev.autosize.core.net.ServerException;
import com.dev.autosize.core.util.ActivityUtils;
...
public abstract class BaseObserver<T> extends ResourceObserver<T> {
   ...
   /* @Override
    ...
    protected void onStart() {
        ...
        if (mDialogView != null) {
            mDialogView.showLoadingProgress(msg);
        }
    ...
    public void onComplete() {
        // L.d("执行结果");
        if (mDialogView != null) {
            mDialogView.dismissLoadingProgress();
